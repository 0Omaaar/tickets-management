                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="editTitle" name="title" class="form-control"
                                placeholder="Titre du ticket" disabled>
                        </div>

                        <div class="form-group mb-3">
                            <label for="editModule">Module</label>
                            <select id="editModule" name="module_id" class="form-control" disabled>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="editPriority" name="priority" class="form-control" disabled>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="editProject" name="project_id" class="form-control" disabled>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select id="editStatus" name="status" class="form-control" disabled>
                    ...
                    <div class="col-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea id="editDescription" name="description" class="form-control" rows="4"
                                placeholder="Décrivez votre problème en détail..." disabled></textarea>
                        </div>
                    </div>
                </div>
            </form>
